...
public class SequencePlayerTest{
    ...
    public void piece1Test(){
        ...
        try {
            ...
            // minute, with 12 ticks per quarter note (we have triplets where each is 1/12)
    ...
    public void piece2Test(){
        ...
        try {
            ...
            // create a new player, with 200 beats per
            // minute, with 6 ticks per quarter note (we have triplets where each is 1/12 and a 16th)
